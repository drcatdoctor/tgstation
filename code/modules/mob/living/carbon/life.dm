...
/mob/living/carbon/proc/check_breath(datum/gas_mixture/breath)
	...
	//TRITIUM OXIDE
	if(breath_gases[/datum/gas/tritium_oxide])
		var/tritium_oxide_partialpressure = (breath_gases[/datum/gas/tritium_oxide][MOLES]/breath.total_moles())*breath_pressure
		radiation += tritium_oxide_partialpressure*1000 // give em the business
