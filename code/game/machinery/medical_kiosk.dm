...
/obj/machinery/medical_kiosk/ui_data(mob/living/carbon/human/user)
	...
	if(rad_sickness_value >= 1000)  //
		...
		rad_sickness_status = "Patient is suffering from alarming radiation poisoning. Suggested treatment: Take Cold Seiver or Potassium Iodine, monitor toxin levels."
